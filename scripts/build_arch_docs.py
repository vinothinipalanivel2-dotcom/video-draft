...
# 2. Architecture Doc
arch_content = """# System Architecture & Technical Design
...
|      * NewsStrategy: 3-beat structure (Breaking Headline, Context & Impact, Outro/Next Steps)     |
...
|  - ModelRegistry: 5 open-weight models (AnimateDiff, ModelScope, ZeroScope, SVD, CogVideoX)       |
...
Path("submission/architecture.md").write_text(arch_content.strip() + "\n", encoding="utf-8")
Path("docs/final_architecture.md").write_text(arch_content.strip() + "\n", encoding="utf-8")
print("Wrote submission/architecture.md and docs/final_architecture.md")
