...
readme_content = """# video-draft: Open-Source Draft Video Generation and Model Routing
...
### Run Full Test Suite (135+ Passing Tests)
```bash
pytest -v
```
...
- **AnimateDiff v1.5** (Apache-2.0)
- **ModelScope Text-to-Video** (CC-BY-NC-4.0)
- **ZeroScope v2 576w** (CC-BY-NC-4.0)
- **Stable Video Diffusion XT** (OpenRAIL-M)
- **CogVideoX-5B** (Apache-2.0)
- **CPU Procedural Engine** (Apache-2.0, Built-in)
